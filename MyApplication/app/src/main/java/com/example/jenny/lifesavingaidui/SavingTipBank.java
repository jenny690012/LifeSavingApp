...
public class SavingTipBank extends Activity {
    ...
    String[] first_aid_tips= {"Allergies","Asthma Attack","Bleeding","Broken Bone","Burns",
                              "Choking","Diabetic Emergency","Head Injury","Heat Stroke",
                              "Hypothermia","Meningitis","Poisoning","Seizure","Stroke",
                              "Strains and Sprains","Unconscious"};
    ListView listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageView parent = (ImageView) findViewById(R.id.savingTipBank_imageView);
        parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (NavUtils.getParentActivityName(SavingTipBank.this) != null)
                    NavUtils.navigateUpFromSameTask(SavingTipBank.this);
            }
        });
    }
    ...
    private class ItemListLongClick implements AdapterView.OnItemLongClickListener{
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Toast.makeText(SavingTipBank.this,"Item has been added",Toast.LENGTH_SHORT).show();
            return true;
        }
    }
