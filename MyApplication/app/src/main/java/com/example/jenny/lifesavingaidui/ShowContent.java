...
public class ShowContent extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
             ...
             try {
                 ...
                 if (ContextCompat.checkSelfPermission(ShowContent.this,//probaly useless since we already set permision
                         android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                     startActivity(call);
                 } else {
                     Toast.makeText(ShowContent.this, "User does not allow perssion to call",
                             Toast.LENGTH_SHORT).show();
                 }
             } catch (Exception e){
                 Toast.makeText(ShowContent.this, "Calling 911 failed",
                         Toast.LENGTH_SHORT).show();
                         e.printStackTrace();
             }
            }
        ...
        ImageView parent = (ImageView) findViewById(R.id.showTip_imageView);
        parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(NavUtils.getParentActivityName(ShowContent.this)!=null)
                    NavUtils.navigateUpFromSameTask(ShowContent.this);
            }
        });
    }
